...
namespace BugTrackerNET.Controllers
{
    ...
    [ApiController]
    public class ContactsGetController : ControllerBase
    {
        private readonly BugTrackerNETContext _context;

        public ContactsGetController(BugTrackerNETContext context)
        {
            _context = context;
        }
        ...
        public ActionResult PostUserDataLogin(UserDataLogin usl)
        {
            ...
            var UserDatasLogin = _context.Contact.Where(e => e.Email.Equals(usl.Email));
